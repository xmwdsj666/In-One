...
Page.syncZones()
Page.onSearchTap()
console.log('[index] 点搜索框开键盘 showKb:', Page.showKb, '(期望 true)')
Page.onToggleKb()
...
Page.goBack()
Page.applyQuery('qwq')
console.log('[index] qwq 彩蛋:', Page.showEgg, '(期望 true)')
Page.applyQuery('abc')
console.log('[index] abc 无彩蛋:', Page.showEgg, '(期望 false)')
Page.onClear()
console.log('[index] 清空后彩蛋:', Page.showEgg, '(期望 false)')
